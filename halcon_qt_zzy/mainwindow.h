...
public:
    ...
    Hlong winId,winId_image,winId_ncc,winId_shape;
    //image
...
private slots:
    ...
    void on_pushButton_1_video_clicked();
...
private:
    ...
    QTimer * timer;
    QTimer * timer_Threshold;
    QString set_camera;
    QString camera_video;
    ...
    int Threshold1,Threshold2,scale1,shape1,shape2,shapearea1,shapearea2;
